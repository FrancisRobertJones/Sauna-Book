...
router.get('/admin-saunas', saunaController.getAdminSaunas as RequestHandler);
...
router.delete('/:id/users/:userId', ((req, res) => saunaController.removeSaunaAccess(req, res)) as RequestHandler);
