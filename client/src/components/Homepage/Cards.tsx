...
export const FeatureCard = ({ 
    ...
    <GlowCard className="bg-background/50 backdrop-blur-lg border-border shadow-lg hover:shadow-xl transition-all duration-300 group">
      <CardHeader>
  ...
  export const StepCard = ({ 
    ...
    <GlowCard className="bg-background/50 backdrop-blur-lg border-border shadow-lg hover:shadow-xl transition-all duration-300">
      <CardHeader>
